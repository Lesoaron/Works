(function () {
  ...
  // YouTube click-to-play embeds (no preview chrome / title bar / watch-on-youtube bar)
  document.querySelectorAll('.embed-w[data-yt]').forEach(box => {
    ...
    box.addEventListener('click', () => {
      ...
      iframe.src = `https://www.youtube.com/embed/${id}?autoplay=1&rel=0&modestbranding=1&controls=0&showinfo=0&iv_load_policy=3&disablekb=1&fs=0&playsinline=1`;
